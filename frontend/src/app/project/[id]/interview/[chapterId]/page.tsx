        ...
        >
          <div className="flex items-end gap-2">
            <textarea
              ...
              placeholder="分享您的故事...（Enter 发送，Shift+Enter 换行）"
              rows={3}
              className="max-h-44 min-h-[72px] flex-1 resize-y rounded-2xl border border-[#e7dfd4] bg-[#fbf7f2] px-5 py-3 text-base leading-relaxed outline-none transition focus:border-[#8b5e3c] focus:bg-white focus:ring-2 focus:ring-[#8b5e3c]/10"
              disabled={sending}
            />
            <button
              type="submit"
