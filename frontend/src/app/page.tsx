      ...
      <div className="mx-auto max-w-6xl px-5 pb-16 pt-8 sm:px-8 sm:pt-10">
        <header className="flex flex-col gap-6 border-b border-[#dfe5eb] pb-7 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <Link href="/community" className="btn-outline inline-flex min-h-11 items-center justify-center gap-2 px-5 py-3 text-sm">
              <CommunityIcon />
              自传社区
            </Link>
            <button
...
function CommunityIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 7h6a4 4 0 014 4v10a3 3 0 00-3-3H2z" /><path d="M22 7h-6a4 4 0 00-4 4v10a3 3 0 013-3h7z" /><path d="M12 5a4 4 0 014-4" /></svg>;
}
