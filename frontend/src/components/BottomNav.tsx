...
interface BottomNavProps { projectId: string; activeChapterId?: string; }

const icons = {
  chapters: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z" /><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z" /></svg>),
  interview: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" /><path d="M8 9h8M8 13h6" /></svg>),
  reading: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" /><line x1="8" y1="7" x2="16" y2="7" /><line x1="8" y1="11" x2="14" y2="11" /></svg>),
...
export function BottomNav({ projectId, activeChapterId }: BottomNavProps) {
  ...
  const interviewHref = activeChapterId ? `/project/${projectId}/interview/${activeChapterId}` : `/project/${projectId}`;
  const chapterHref = activeChapterId ? `/project/${projectId}/chapter/${activeChapterId}` : `/project/${projectId}`;
  ...
  const tabs = [
    ...
    { href: chapterHref, label: "正文", icon: icons.reading, match: "/chapter/" },
